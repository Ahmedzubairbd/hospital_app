...
export async function PATCH(
  ...
  try {
    ...
    const schedule =
      input.schedule !== undefined ? trimOrNull(input.schedule) : undefined;
    ...
    const sliderPictureUrl =
      input.sliderPictureUrl !== undefined
        ...
        : undefined;
    const branchId =
      input.branchId !== undefined ? normalizeId(input.branchId) : undefined;
    const visitingHours =
      input.visitingHours !== undefined
        ? trimOrNull(input.visitingHours)
        : undefined;
    const keywords =
    ...
    const availableFrom =
      input.availableFrom !== undefined
        ? trimOrNull(input.availableFrom)
        : undefined;
    const availableTo =
      input.availableTo !== undefined
        ? trimOrNull(input.availableTo)
        : undefined;
    const weekdays =
      input.weekdays !== undefined ? trimOrNull(input.weekdays) : undefined;
    ...
    if (visitingHours !== undefined)
      doctorUpdateData.visitingHours = visitingHours;
    if (keywords !== undefined) doctorUpdateData.keywords = keywords;
    if (availableFrom !== undefined)
      doctorUpdateData.availableFrom = availableFrom;
    ...
    if (input.directoryProfile !== undefined) {
      const directoryProfile = normalizeDirectoryProfile(
        input.directoryProfile,
        {
      ...
      sliderPictureUrl !== undefined &&
      existingDoctor.directoryProfile
    ) {
      const profile = {
