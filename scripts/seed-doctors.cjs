...
const doctors = [
  {
    ...
    image: "/assets/doctors/Mir Mahfuzul Haque Chowdhury/MirMahfuzulHaque.jpg",
  ...
  },
  {
    ...
    qualifications: [
      {
        en: "MBBS (Dhaka Medical College)",
        bn: "এমবিবিএস (ঢাকা মেডিকেল কলেজ)",
      },
  ...
  },
  {
    ...
    name: {
      en: "Dr. Sukumar Chandra Chakraborty",
      bn: "ডা. সুকুমার চন্দ্র চক্রবর্তী",
    },
    ...
    keywords: ["dermatology", "skin", "sukumar", "চর্মরোগ", "এলার্জি"],
  ...
  },
  {
    ...
    // ],
    keywords: ["ultrasound", "radiology", "sanjit", "কর্মকার", "রেডিওলজি"],
  ...
  },
  {
    ...
    keywords: ["radiology", "imaging", "sujit", "ডপলার", "ইমেজিং"],
  ...
  },
  {
    ...
    keywords: ["radiology", "nasima", "women", "ইমেজিং", "নাসিমা"],
  ...
  },
  {
    ...
    keywords: ["neurology", "stroke", "pramanik", "নিউরো"],
  ...
  },
  {
    ...
    keywords: ["dermatology", "venereology", "mintu", "চর্ম"],
  ...
  },
  {
    ...
    keywords: ["gastroenterology", "liver", "mukul", "লিভার", "গ্যাস্ট্রো"],
  ...
  },
  {
    ...
    keywords: ["pediatrics", "neonatal", "ayub", "শিশু"],
  ...
  },
  {
    ...
    keywords: ["pediatrics", "immunization", "firoz", "শিশু"],
  ...
  },
  {
    ...
    keywords: ["pediatrics", "development", "sumon", "শিশু"],
  ...
  },
  {
    ...
    keywords: ["pediatrics", "preventive", "sabiha", "শিশু"],
  ...
  },
  {
    ...
    keywords: ["medicine", "chronic", "piyush", "মেডিসিন"],
